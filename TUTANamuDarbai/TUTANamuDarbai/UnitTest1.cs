...
namespace TUTANamuDarbai
{
    public class Tests
    {
        ...
        public void Test1()
        {
            ...
            username.SendKeys("Testas66");

            var password = driver.FindElement(By.Id("sign-password"));
            password.SendKeys("Testas66");
        ...
        public void Test2()
        {
            ...
            var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));
            wait.Until(ExpectedConditions.ElementIsVisible(By.LinkText("Welcome Testas66")));

            var confirmation = driver.FindElement(By.Id("nameofuser"));
            Assert.That(confirmation.Text, Is.EqualTo("Welcome Testas66"));
